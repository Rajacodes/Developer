                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="forgetpassword.php"  method="post">
                                        ...
                                        <input type="submit" class="btn btn-primary btn-user btn-block"
                                                 name="forget" value="Reset Password"
                                                >
                                    </form>
                                    <hr>
                                    <div class="text-center">
...
if(isset($_REQUEST['forget'])){
	...
	if(mysqli_num_rows($emailrun) > 0){
        try {
            ...
            $message = '<div>
            <h2> If you forget your password JKR Fencing company will help you to change your password using below link </h2><br>
            <p><button class="btn btn-primary"><a href="http://localhost/shop/passwordchange.php?secret='.base64_encode($email).'">CLICK ME</a></button></p>                             
            </div>';
